# AMOC 3-Box Model — Interactive Simulation Dashboard
...
|-----------|-----------------|----------------|
| **Greenland meltwater flux** | Freshwater runoff from the Greenland ice sheet into the North Atlantic | Directly dilutes the North, reducing its density and sinking. The fastest path to collapse |
...
Despite these simplifications, the Rooth 3-box model correctly captures the key qualitative behaviors of the AMOC: thermohaline-driven overturning, sensitivity to freshwater forcing, bistability, and hysteresis.
